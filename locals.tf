locals {
  ...
  security_group_name_app   = "${terraform.workspace}-${var.suffix}-app"
  security_group_name_lb    = "${terraform.workspace}-${var.suffix}-lb"
  security_group_name_redis = "${terraform.workspace}-${var.suffix}-redis"
  ...
  alb-name                  = "${terraform.workspace}-${var.suffix}-alb-name"
  targetgroup               = "${terraform.workspace}-${var.suffix}-targetgroup"
  cloudwatch-logs           = "${terraform.workspace}-${var.suffix}-cloudwatch-logs"
